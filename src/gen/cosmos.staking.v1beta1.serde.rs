                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        ...
                        GeneratedField::AllowList => {
                            ...
                            validators__ = map.next_value::<::std::option::Option<_>>()?.map(stake_authorization::Policy::AllowList)
;
                        }
                        GeneratedField::DenyList => {
                            ...
                            validators__ = map.next_value::<::std::option::Option<_>>()?.map(stake_authorization::Policy::DenyList)
;
                        }
                    }
                }
