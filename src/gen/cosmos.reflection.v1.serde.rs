...
impl<'de> serde::Deserialize<'de> for FileDescriptorsRequest {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<FileDescriptorsRequest, V::Error>
                where
...
impl<'de> serde::Deserialize<'de> for FileDescriptorsResponse {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<FileDescriptorsResponse, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
