...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(GrpcMethod::new("evmos.erc20.v1.Query", "TokenPairs"));
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("evmos.erc20.v1.Query", "TokenPair"));
            self.inner.unary(req, path, codec).await
        }
        pub async fn params(
            &mut self,
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("evmos.erc20.v1.Query", "Params"));
            self.inner.unary(req, path, codec).await
        }
    }
}
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("evmos.erc20.v1.Msg", "ConvertCoin"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("evmos.erc20.v1.Msg", "ConvertERC20"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("evmos.erc20.v1.Msg", "UpdateParams"));
            self.inner.unary(req, path, codec).await
        }
    }
}
