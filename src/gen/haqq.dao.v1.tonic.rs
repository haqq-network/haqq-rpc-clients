...
pub mod query_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn total_balance(
            &mut self,
            request: impl tonic::IntoRequest<super::QueryTotalBalanceRequest>,
        ) -> std::result::Result<
            tonic::Response<super::QueryTotalBalanceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod msg_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + Send,
    {
        ...
        pub async fn fund(
            &mut self,
            request: impl tonic::IntoRequest<super::MsgFund>,
        ) -> std::result::Result<
            tonic::Response<super::MsgFundResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
