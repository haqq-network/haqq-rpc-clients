...
// @generated from file haqq/dao/v1/dao.proto (package haqq.dao.v1, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum haqq.dao.v1.CollateralValueType
 */
...
proto3.util.setEnumType(CollateralValueType, "haqq.dao.v1.CollateralValueType", [
 ...
 *
 * @generated from message haqq.dao.v1.Params
 */
export class Params extends Message<Params> {
   ...
   *
   * @generated from field: repeated haqq.dao.v1.AllowedCollateral allowed_collaterals = 2;
   */
  ...
  static readonly typeName = "haqq.dao.v1.Params";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "enable_dao", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
    { no: 2, name: "allowed_collaterals", kind: "message", T: AllowedCollateral, repeated: true },
  ]);
...
/**
 * @generated from message haqq.dao.v1.AllowedCollateral
 */
export class AllowedCollateral extends Message<AllowedCollateral> {
   ...
   *
   * @generated from field: haqq.dao.v1.CollateralValueType type = 2;
   */
  ...
  static readonly runtime: typeof proto3 = proto3;
  static readonly typeName = "haqq.dao.v1.AllowedCollateral";
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "value", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "type", kind: "enum", T: proto3.getEnumType(CollateralValueType) },
  ]);

  static fromBinary(bytes: Uint8Array, options?: Partial<BinaryReadOptions>): AllowedCollateral {
    return new AllowedCollateral().fromBinary(bytes, options);
  }

  static fromJson(jsonValue: JsonValue, options?: Partial<JsonReadOptions>): AllowedCollateral {
    return new AllowedCollateral().fromJson(jsonValue, options);
  }

  static fromJsonString(jsonString: string, options?: Partial<JsonReadOptions>): AllowedCollateral {
    return new AllowedCollateral().fromJsonString(jsonString, options);
  }

  static equals(a: AllowedCollateral | PlainMessage<AllowedCollateral> | undefined, b: AllowedCollateral | PlainMessage<AllowedCollateral> | undefined): boolean {
