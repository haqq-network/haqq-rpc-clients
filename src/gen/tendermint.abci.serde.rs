...
impl serde::Serialize for BlockParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("tendermint.abci.BlockParams", len)?;
        if self.max_bytes != 0 {
...
impl<'de> serde::Deserialize<'de> for BlockParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct tendermint.abci.BlockParams")
            }
        ...
        deserializer.deserialize_struct("tendermint.abci.BlockParams", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for ConsensusParams {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("tendermint.abci.ConsensusParams", len)?;
...
impl<'de> serde::Deserialize<'de> for ConsensusParams {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct tendermint.abci.ConsensusParams")
            }
        ...
        deserializer.deserialize_struct("tendermint.abci.ConsensusParams", FIELDS, GeneratedVisitor)
    }
}
...
impl serde::Serialize for Evidence {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("tendermint.abci.Evidence", len)?;
        if self.r#type != 0 {
            let v = EvidenceType::from_i32(self.r#type)
...
impl<'de> serde::Deserialize<'de> for Evidence {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct tendermint.abci.Evidence")
            }
                ...
                while let Some(k) = map.next_key()? {
                    match k {
                        GeneratedField::Type => {
                            ...
                            r#type__ = Some(map.next_value::<EvidenceType>()? as i32);
                        }
                        GeneratedField::Validator => {
                            if validator__.is_some() {
                                return Err(serde::de::Error::duplicate_field("validator"));
        ...
        deserializer.deserialize_struct("tendermint.abci.Evidence", FIELDS, GeneratedVisitor)
    }
}
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
                ...
                E: serde::de::Error,
            {
                ...
                i32::try_from(v)
                    .ok()
                    .and_then(EvidenceType::from_i32)
                    .ok_or_else(|| {
                        serde::de::Error::invalid_value(serde::de::Unexpected::Signed(v), &self)
                    })
            }
...
impl serde::Serialize for LastCommitInfo {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("tendermint.abci.LastCommitInfo", len)?;
        if self.round != 0 {
...
impl<'de> serde::Deserialize<'de> for LastCommitInfo {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct tendermint.abci.LastCommitInfo")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<LastCommitInfo, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
        ...
        deserializer.deserialize_struct("tendermint.abci.LastCommitInfo", FIELDS, GeneratedVisitor)
    }
}
...
;
                        ...
                        GeneratedField::SetOption => {
                            ...
                            value__ = map.next_value::<::std::option::Option<_>>()?.map(request::Value::SetOption)
;
                        }
...
impl serde::Serialize for RequestSetOption {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("tendermint.abci.RequestSetOption", len)?;
        if !self.key.is_empty() {
...
impl<'de> serde::Deserialize<'de> for RequestSetOption {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct tendermint.abci.RequestSetOption")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<RequestSetOption, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut key__ = None;
        ...
        deserializer.deserialize_struct("tendermint.abci.RequestSetOption", FIELDS, GeneratedVisitor)
    }
}
...
;
                        ...
                        GeneratedField::SetOption => {
                            ...
                            value__ = map.next_value::<::std::option::Option<_>>()?.map(response::Value::SetOption)
;
                        }
                        GeneratedField::InitChain => {
                            if value__.is_some() {
...
impl serde::Serialize for ResponseSetOption {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("tendermint.abci.ResponseSetOption", len)?;
        if self.code != 0 {
            struct_ser.serialize_field("code", &self.code)?;
        }
        if !self.log.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ResponseSetOption {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct tendermint.abci.ResponseSetOption")
            }

            fn visit_map<V>(self, mut map: V) -> std::result::Result<ResponseSetOption, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut code__ = None;
        ...
        deserializer.deserialize_struct("tendermint.abci.ResponseSetOption", FIELDS, GeneratedVisitor)
    }
}
