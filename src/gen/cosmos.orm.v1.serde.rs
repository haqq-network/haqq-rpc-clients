...
impl<'de> serde::Deserialize<'de> for PrimaryKeyDescriptor {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<PrimaryKeyDescriptor, V::Error>
                where
...
impl<'de> serde::Deserialize<'de> for SecondaryIndexDescriptor {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<SecondaryIndexDescriptor, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut fields__ = None;
