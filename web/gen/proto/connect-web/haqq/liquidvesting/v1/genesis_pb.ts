...
export class GenesisState extends Message<GenesisState> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    ...
    { no: 2, name: "denom_counter", kind: "scalar", T: 4 /* ScalarType.UINT64 */ },
...
export class Params extends Message<Params> {
  ...
  static readonly fields: FieldList = proto3.util.newFieldList(() => [
    { no: 1, name: "minimum_liquidation_amount", kind: "scalar", T: 9 /* ScalarType.STRING */ },
    { no: 2, name: "enable_liquid_vesting", kind: "scalar", T: 8 /* ScalarType.BOOL */ },
  ]);
