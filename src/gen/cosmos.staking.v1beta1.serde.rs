        ...
        S: serde::Serializer,
    {
        ...
        if self.authorization_type != 0 {
            let v = AuthorizationType::try_from(self.authorization_type)
                .map_err(|_| serde::ser::Error::custom(format!("Invalid variant {}", self.authorization_type)))?;
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::AllowList => {
                            ...
                            validators__ = map_.next_value::<::std::option::Option<_>>()?.map(stake_authorization::Policy::AllowList)
;
                        }
                        GeneratedField::DenyList => {
                            ...
                            validators__ = map_.next_value::<::std::option::Option<_>>()?.map(stake_authorization::Policy::DenyList)
;
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for stake_authorization::Validators {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<stake_authorization::Validators, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut address__ = None;
