                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Str => {
                            ...
                            value__ = map_.next_value::<::std::option::Option<_>>()?.map(index_value::Value::Str);
                        }
                        ...
                        GeneratedField::Enum => {
                            ...
                            value__ = map_.next_value::<::std::option::Option<_>>()?.map(index_value::Value::Enum);
                        }
                        GeneratedField::Bool => {
                            if value__.is_some() {
                                return Err(serde::de::Error::duplicate_field("bool"));
                            }
                            value__ = map_.next_value::<::std::option::Option<_>>()?.map(index_value::Value::Bool);
                        }
                        GeneratedField::Timestamp => {
                            if value__.is_some() {
                                return Err(serde::de::Error::duplicate_field("timestamp"));
                            }
                            value__ = map_.next_value::<::std::option::Option<_>>()?.map(index_value::Value::Timestamp)
;
                        }
                        GeneratedField::Duration => {
                            ...
                            value__ = map_.next_value::<::std::option::Option<_>>()?.map(index_value::Value::Duration)
;
                        }
                    }
                }
                ...
                while let Some(k) = map_.next_key()? {
                    match k {
                        ...
                        GeneratedField::Prefix => {
                            ...
                            query__ = map_.next_value::<::std::option::Option<_>>()?.map(list_request::Query::Prefix)
;
                        }
                        GeneratedField::Range => {
                            ...
                            query__ = map_.next_value::<::std::option::Option<_>>()?.map(list_request::Query::Range)
;
                        }
                    }
                }
...
impl<'de> serde::Deserialize<'de> for list_request::Prefix {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn visit_map<V>(self, mut map_: V) -> std::result::Result<list_request::Prefix, V::Error>
                where
                    V: serde::de::MapAccess<'de>,
            {
                let mut values__ = None;
